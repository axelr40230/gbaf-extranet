    ...
    <div class="mega">
        ...
        <div class="big-container">
            <form action="" method="post">
                <p class="red-text"><?php require '../src/php/processing-recording.php';?></p>
                <div class="field-form"><label for="nom"><input type="text" name="nom" id="nom" placeholder="Votre nom"></label></div>
                <div class="field-form"><label for="prenom"><input type="text" name="prenom" id="prenom" placeholder="Votre prénom"></label></div>
                <div class="field-form"><label for="user"><input type="text" name="user" id="user" placeholder="Votre nom d'utilisateur"></label></div>
                <div class="field-form"><label for="pass"><input type="password" name="pass" id="pass" placeholder="Votre mot de passe"></label></div>
                <div class="field-form"><label for="pass-confirm"><input type="password" name="pass-confirm" id="pass-confirm" placeholder="Répétez votre mot de passe"></label></div>
              <div class="field-form">
                ...
                <p class="content">Conservez bien votre question secrète ainsi que sa réponse pour pouvoir récupérer votre mot de passe au besoin.</p>
                <div class="field-form"><input type="submit" value="Je m'inscris !" class="bouton rouge" name="valider"></div>
